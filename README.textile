...
There are a couple of examples included with this package. Or, if you can't wait to download it, see it live on the "responsive demo":https://srobbin.github.com/jquery-pageslide or "original project page":http://srobbin.com/blog/jquery-pageslide/.
